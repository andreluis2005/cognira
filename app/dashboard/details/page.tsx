    ...
    return (
        <div className="flex flex-col space-y-9 max-w-md mx-auto pt-7 pb-44 px-7">
            ...
            <header className="flex items-center justify-between h-12">
                <Link href="/dashboard" className="w-[3.25rem] h-[3.25rem] flex items-center justify-center primary-card !rounded-2xl hover:bg-zinc-800 transition-colors">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-zinc-400"><path d="M19 12H5M12 19l-7-7 7-7" /></svg>
                </Link>
                <h1 className="text-[1.15rem] font-bold tracking-tight text-white/95">Detalhes do Progresso</h1>
                <div className="w-[3.25rem]" /> {/* Spacer for centering */}
            </header>
            ...
            {/* Escopo da Certificação Hierárquico */}
